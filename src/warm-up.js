...
var sequel = `Refactered!  Sequel to '${title}'`;
console.log(sequel);
...
var books = ["Pride and Prejustice", "To Kill a Mockingbird", "The Great Gatsby", "In Cold Blood", "Becoming"];
...
var belowTwoHundred = [27, 83, 59, 29, 45, 12, 16, 98, 123, 145, 34, 56];
